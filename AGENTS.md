...
### Product
FinCasa is a single Flask web app (personal/family finance). Local default DB is SQLite (`instance/financeiro.db`); no Redis/Postgres daemon is required for day-to-day development.
