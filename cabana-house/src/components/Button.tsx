...
export function Button({ href, children, variant = 'gold', className = '', external }: ButtonProps) {
  const base =
    'inline-flex items-center justify-center min-h-12 px-6 text-[0.78rem] font-bold tracking-[0.18em] uppercase rounded-full transition duration-200 ease-out hover:-translate-y-0.5 active:translate-y-0'
  const styles = {
