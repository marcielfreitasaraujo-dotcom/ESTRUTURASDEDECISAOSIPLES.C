  ...
  return (
    <section id="cardapio" className="bg-ink py-24">
      <div className="mx-auto max-w-site px-4 md:px-6">
        <p className="text-[0.72rem] font-bold tracking-[0.28em] text-gold">Cardápio</p>
        ...
        <p className="mt-3 max-w-lg text-sm text-mist/60">
          Estrutura pronta para o cardápio oficial. Os itens abaixo são demonstrativos até a
          ...
          {menuFilters.map((f) => {
            ...
            return (
              <button
                ...
                className={`min-h-11 rounded-full px-4 text-[0.72rem] font-bold uppercase tracking-[0.14em] transition ${
