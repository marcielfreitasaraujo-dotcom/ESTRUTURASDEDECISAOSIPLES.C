...
def test_detalhe_cartao_tem_menu_acoes(admin_client, app):
    ...
    assert "btn-mais" in html
    assert "menu-acoes-parcela" in html
    assert "menu-popover" in html
    assert "modal-editar-parcela" in html
    assert "Excluir" in html
    assert "acoes-parcela" in html
    assert "portal-menu-acoes" not in html
    assert "acoes-parcela-btns" not in html
