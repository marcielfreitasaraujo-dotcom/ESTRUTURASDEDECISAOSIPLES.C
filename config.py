...
class Config:
    ...
    # Pagamentos (Mercado Pago: PIX automático; cartão opcional)
    ...
    # Cartão desligado por padrão (plano barato); ligue com ASSINATURA_CARTAO_HABILITADO=1
    ASSINATURA_CARTAO_HABILITADO = _bool_env("ASSINATURA_CARTAO_HABILITADO", False)
