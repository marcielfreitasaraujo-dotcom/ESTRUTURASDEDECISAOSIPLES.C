    ...
    <div className="grid gap-6">
      ...
      {canWrite ? (
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Novo motoboy</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-xl border bg-card">
          <h2 className="border-b px-4 py-3 text-sm font-semibold">Zonas</h2>
          {zones.length === 0 ? (
            <div className="p-4">
            ...
            <ul>
              {zones.map((zone) => (
                <li key={zone.id} className="border-b px-4 py-3 text-sm last:border-0">
        ...
        <section className="rounded-xl border bg-card">
          <h2 className="border-b px-4 py-3 text-sm font-semibold">Motoboys</h2>
          {drivers.length === 0 ? (
            <div className="p-4">
            ...
            <ul>
              {drivers.map((driver) => (
                <li key={driver.id} className="border-b px-4 py-3 text-sm last:border-0">
